...
CFLAGS=$(TARGET_CFLAGS) -Wall -Wextra -Wno-error=strict-prototypes -Wno-error=unused-function -pedantic -Werror -masm=intel -I/usr/include/efi -I./src -I./xed/obj/wkit/include/xed -O3 -DCOUNT_NOPS -DCPU_MODE=$(CPU_MODE) -DCOUNT_XED_VS_CPU_MISMATCHES -DTARGET_UARCH=$(TARGET_UARCH) -flto=full
